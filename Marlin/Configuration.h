...
#define STRING_CONFIG_H_AUTHOR "(Dan Timu, Anet config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // (measured after M106 S255 with M303 E0 S210 C8)
    ...
    // Calculated by me, perhaps no silicone sock
    // #define DEFAULT_Kp  26.60
    // #define DEFAULT_Ki   1.95
    // #define DEFAULT_Kd  89.90
    // Recent autotune, with silicone sock
    #define DEFAULT_Kp 48.48
    #define DEFAULT_Ki 4.89
    #define DEFAULT_Kd 120.24
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 34.65
  #define DEFAULT_bedKd 669.67
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 95.2 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -24, -38, -1.8 }
